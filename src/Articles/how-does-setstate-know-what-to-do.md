...
# Source of Overreacted

[Overreacted.io](https://overreacted.io) is a personal blog by `Dan Abramov`, a well-known software developer who has contributed to various open-source projects, including React, Redux, and Create React App. In this blog, Dan Abramov shares insights on software development, his experiences working with React and related technologies, and his ideas and perspectives on various technology and web development topics.

The blog is known for its in-depth articles focused on core concepts of software development. So, if you are interested in web development, especially with React, the blog overreacted.io can be a valuable source of information.
